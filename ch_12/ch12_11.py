...
dst9o = cv2.morphologyEx(src, cv2.MORPH_OPEN, kernel9)
dst9e = cv2.erode(src, kernel9)
dst9d = cv2.dilate(dst9e, kernel9)


cv2.imshow('Src', src)
cv2.imshow('Open - Dst 9x9', dst9o)
cv2.imshow('Open - 1.Erode 9x9', dst9e)
cv2.imshow('Open - 2.Dilate 9x9', dst9d)
